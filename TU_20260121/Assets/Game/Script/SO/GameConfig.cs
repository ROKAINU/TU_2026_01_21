...
namespace Game
{
    ...
    internal class GameConfig : ScriptableObject
    {
        ...
        [SerializeField]private float deathZoneOffsetX;
        [SerializeField]private float deathZoneOffsetY;
        ...
        public float DeathZoneOffsetX => deathZoneOffsetX;
        public float DeathZoneOffsetY => deathZoneOffsetY;
    }
}